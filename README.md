Here is a list of the files I created/edited, the rest is all the default boilerplate that comes with the Visual Studio 2022 "React and ASP.NET CORE" template
